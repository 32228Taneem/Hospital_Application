...
const PatientDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchPatientsAndDoctors = async () => {
      try {
        const patientsResponse = await axios.get('https://doc-back.onrender.com/patients'); // Replace with your actual endpoint
        const doctorsResponse = await axios.get('https://doc-back.onrender.com/doctors'); // Replace with your actual endpoint
  ...
  const handleDelete = async (patientId) => {
    try {
      await axios.delete(`https://doc-back.onrender.com/patients/${patientId}`);
